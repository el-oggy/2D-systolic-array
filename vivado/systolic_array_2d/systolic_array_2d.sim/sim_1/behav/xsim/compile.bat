...
REM
REM Generated by Vivado on Wed Aug 26 22:20:41 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_step2_systolic_2x2_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_step2_systolic_2x2_vlog.prj -log xvlog.log
