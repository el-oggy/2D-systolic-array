...
HD_PWD='C:/Users/adars/OneDrive/Desktop/Edge- AI Hackthon/vivado/systolic_array_2d/systolic_array_2d.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_demo_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basys3_demo_top.tcl
