...
HD_PWD='C:/Users/adars/OneDrive/Desktop/Edge- AI Hackthon/vivado/systolic_array_2d/systolic_array_2d.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_demo_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basys3_demo_top.tcl -notrace
