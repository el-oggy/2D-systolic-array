...
HD_PWD='C:/Users/adars/OneDrive/Desktop/vs-code/2D systolic array/2D systolic array.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processing_element.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processing_element.tcl
