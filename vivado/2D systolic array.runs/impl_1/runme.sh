...
HD_PWD='C:/Users/adars/OneDrive/Desktop/vs-code/2D systolic array/2D systolic array.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processing_element.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processing_element.tcl -notrace
